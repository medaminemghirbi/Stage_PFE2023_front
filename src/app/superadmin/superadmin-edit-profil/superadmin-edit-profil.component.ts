...
@Component({
  selector: 'app-superadmin-edit-profil',
  templateUrl: './superadmin-edit-profil.component.html',
  styleUrls: ['./superadmin-edit-profil.component.css']
})
export class SuperadminEditProfilComponent {
  ...
  updatenewuser (f:any){
   ...
   // formData.append('avatar', this.image );
    ...
    this.sprservice.updateProfileUser(this.userdata.id,formData).subscribe(response=>
     ...
     this.route.navigate(['/edit-superadmin']);
        Swal.fire('Saved!', '', 'success')
      } else if (result.isDenied) {
        Swal.fire('Changes are not saved', '', 'info')
      }
