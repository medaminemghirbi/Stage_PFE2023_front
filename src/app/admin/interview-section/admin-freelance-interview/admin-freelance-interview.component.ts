...
@Component({
  selector: 'app-admin-freelance-interview',
  templateUrl: './admin-freelance-interview.component.html',
  styleUrls: ['./admin-freelance-interview.component.css']
})
export class AdminFreelanceInterviewComponent {
  ...
  ngOnInit(): void {
    ...
    this.adservice.getInterviewFreelanceCondidature(this.userdata.id).subscribe(data => {
      this.dataArray = data
