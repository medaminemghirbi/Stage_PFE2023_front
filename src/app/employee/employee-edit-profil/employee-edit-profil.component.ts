...
@Component({
  selector: 'app-employee-edit-profil',
  templateUrl: './employee-edit-profil.component.html',
  styleUrls: ['./employee-edit-profil.component.css']
})
export class EmployeeEditProfilComponent {
